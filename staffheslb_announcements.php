...
$sql = "SELECT heslb.AnnouncementID, heslb.Title, AnnouncementCategories.CategoryName, heslb.PostedBy, heslb.PostedDate, heslb.AttachmentPath, heslb.AttachmentType, Users.Username 
        FROM heslb
        JOIN AnnouncementCategories ON heslb.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON heslb.PostedBy = Users.UserID
        ORDER BY heslb.PostedDate DESC";
...
<body>
    ...
    <div class="container">
        <div class="grid-container">
            ...
            <a href="addannouncementstaffgeneral.php" class="add-announcement">+</a>
