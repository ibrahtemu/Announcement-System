...
$sql = "SELECT extra.AnnouncementID, extra.Title, AnnouncementCategories.CategoryName, extra.PostedBy, extra.PostedDate, extra.AttachmentPath, extra.AttachmentType, Users.Username 
        FROM extra
        JOIN AnnouncementCategories ON extra.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON extra.PostedBy = Users.UserID
        ORDER BY extra.PostedDate DESC";
