...
$sql = "SELECT t_factory.AnnouncementID, t_factory.Title, AnnouncementCategories.CategoryName, t_factory.PostedBy, t_factory.PostedDate, t_factory.AttachmentPath, t_factory.AttachmentType, Users.Username 
        FROM t_factory
        JOIN AnnouncementCategories ON t_factory.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON t_factory.PostedBy = Users.UserID
        ORDER BY t_factory.PostedDate DESC";
...
<body>
    <header>
    <h1>Teaching Factory <br>Announcements</h1>
    </header>
    <div class="container">
