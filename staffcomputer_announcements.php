...
$sql = "SELECT computerdept.AnnouncementID, computerdept.Title, AnnouncementCategories.CategoryName, computerdept.PostedBy, computerdept.PostedDate, computerdept.AttachmentPath, computerdept.AttachmentType, Users.Username 
        FROM computerdept
        JOIN AnnouncementCategories ON computerdept.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON computerdept.PostedBy = Users.UserID
        ORDER BY computerdept.PostedDate DESC";
...
<body>
    <header>
    <h1>Computer <br>Announcements</h1>
    </header>
    <div class="container">
        <div class="grid-container">

            <a href="addannouncementstaffcomputer.php" class="add-announcement">+</a>
