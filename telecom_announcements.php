...
$sql = "SELECT telecom_dept.AnnouncementID, telecom_dept.Title, AnnouncementCategories.CategoryName, telecom_dept.PostedBy, telecom_dept.PostedDate, telecom_dept.AttachmentPath, telecom_dept.AttachmentType, Users.Username 
        FROM telecom_dept
        JOIN AnnouncementCategories ON telecom_dept.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON telecom_dept.PostedBy = Users.UserID
        ORDER BY telecom_dept.PostedDate DESC";
...
<body>
    <header>
    <h1>Telecom Department <br>Announcements</h1>
    </header>
    <div class="container">
