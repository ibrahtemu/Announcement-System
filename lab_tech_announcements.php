...
$sql = "SELECT sci_lab_tech.AnnouncementID, sci_lab_tech.Title, AnnouncementCategories.CategoryName, sci_lab_tech.PostedBy, sci_lab_tech.PostedDate, sci_lab_tech.AttachmentPath, sci_lab_tech.AttachmentType, Users.Username 
        FROM sci_lab_tech
        JOIN AnnouncementCategories ON sci_lab_tech.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON sci_lab_tech.PostedBy = Users.UserID
        ORDER BY sci_lab_tech.PostedDate DESC";
...
<body>
    <header>
    <h1>Laboratory Department <br>Announcements</h1>
    </header>
    <div class="container">
