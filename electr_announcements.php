...
$sql = "SELECT electr_dept.AnnouncementID, electr_dept.Title, AnnouncementCategories.CategoryName, electr_dept.PostedBy, electr_dept.PostedDate, electr_dept.AttachmentPath, electr_dept.AttachmentType, Users.Username 
        FROM electr_dept
        JOIN AnnouncementCategories ON electr_dept.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON electr_dept.PostedBy = Users.UserID
        ORDER BY electr_dept.PostedDate DESC";
...
<body>
    <header>
    <h1>Electrical Department <br>Announcements</h1>
    </header>
    <div class="container">
