...
$sql = "SELECT ditso.AnnouncementID, ditso.Title, AnnouncementCategories.CategoryName, ditso.PostedBy, ditso.PostedDate, ditso.AttachmentPath, ditso.AttachmentType, Users.Username 
        FROM ditso
        JOIN AnnouncementCategories ON ditso.CategoryID = AnnouncementCategories.CategoryID 
        JOIN Users ON ditso.PostedBy = Users.UserID
        ORDER BY ditso.PostedDate DESC";
